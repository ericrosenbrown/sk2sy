...
def deterministic_partition_options(transitions: list, eps:float = 1e-2, min_samples:float = 5) -> list:
...
def probablistic_partition_options(transitions: list, eps:float = 1e-2, min_samples:float = 5) -> list:
